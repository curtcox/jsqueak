...
class FileSystemPrimitives
{
    ...
    public FileSystemPrimitives( PrimitiveHandler primitiveHandler )
    {
    ...
    Object openWritable( int argCount )
    {
        ...
        catch (  FileNotFoundException e )
        {
        	...
        	if(e.getMessage().contains("Access is denied")){
        		System.err.println("Win lock semantic trouble...");
        		// Win32 Lock pasticcio
    ...
    {
        return fHandler.charFromInt( File.separatorChar );
    }
